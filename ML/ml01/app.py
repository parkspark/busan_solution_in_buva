...
# ML 04
ML04_01_terms = st.Page("ML04/ML04_01_terms.py", title="한 눈에 보는 핵심 개념", icon="🎯")
ML04_02_jupyter = st.Page("ML04/ML04_02_jupyter.py", title="와인 데이터 결정 트리 & 앙상블 분석 (Jupyter Notebook)", icon="📓")
ML04_03_OOB = st.Page("ML04/ML04_03_OOB.py", title="OOB(Out-Of-Bag) 평가 완벽 이해하기", icon="🎒")
ML04_99_game = st.Page("ML04/ML04_99_game.py", title="마법의 숲 탐정단", icon="🌳")
...
with st.sidebar:
    ...
    st.subheader("ML 04: 결정 트리 & 앙상블")
    st.page_link(ML04_01_terms)
    st.page_link(ML04_02_jupyter)
    st.page_link(ML04_03_OOB)
    st.page_link(ML04_99_game)
