...
ML03_01_Terms = st.Page("ML03_01_Terms.py", title="한 눈에 보는 핵심 개념", icon="🎯")
ML03_02_Fish_LogisticRegression = st.Page("ML03_02_Fish_LogisticRegression.py", title="7종 생선 분류", icon="🐟")
ML03_03_ConfusionMatrix_titanic = st.Page("ML03_03_ConfusionMatrix_titanic.py", title="타이타닉 분류 및 평가", icon="🚢")
ML03_04_BrestCancer = st.Page("ML03_04_BrestCancer.py", title="유방암 진단 임계값 조정", icon="🏥")
